    ...
    <>
      <div className='flex flex-col md:flex-row '>
        <div className='flex flex-col md:mt-8 xl:relative xl:w-3/5'>
          <div className='bg-accent mb-5 md:mb-0 md:p-8 lg:rounded-lg xl:h-full xl:flex xl:items-center xl:justify-center'>
            <Image
            ...
            {product.imageUrls.map((image, index) => (
              ...
              >
                <Image
                  ...
                  width={0}
                  sizes='100vw'
                  className='w-[70px] object-contain p-1 lg:aspect-square '
                />
              </div>
            ))}
          </div>
        ...
        <div className='flex flex-col px-5 pt-8 gap-4 xl:w-2/5'>
      ...
      {productRelation.length > 0 && (
        <div className='mb-8 mt-16 md:mt-24'>
          ...
          <CarouselApp products={productRelation} />
        </div>
      )}
    </>
  )
